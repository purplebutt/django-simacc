...
urlpatterns = [
    ...
    path("coh_detail/<slug:slug>/", coh_view.COHUpdateView.as_view(), name="coh_detail"),
    ...
    path("coa_detail/<slug:slug>/", coa_view.COAUpdateView.as_view(), name="coa_detail"),
    ...
    path("ccf_detail/<slug:slug>/", ccf_view.CCFUpdateView.as_view(), name="ccf_detail"),
    ...
    path("bsg_detail/<slug:slug>/", bsg_view.BSGUpdateView.as_view(), name="bsg_detail"),
    ...
    path("jrb_detail/<slug:slug>/", jrb_view.JRBUpdateView.as_view(), name="jrb_detail"),
